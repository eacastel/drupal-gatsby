...
const getGatsbyImageCdnFields = async ({
  ...
  try {
    ...
    reporter.panicOnBuild(`[gatsby-source-drupal] Encountered an unrecoverable error while generating Gatsby Image CDN fields for url ${url}. See above for additional information.`);
  }
  return {};
};
